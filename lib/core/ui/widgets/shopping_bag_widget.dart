  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        color: Colors.white,
        boxShadow: [BoxShadow(color: Colors.black38, blurRadius: 10, blurStyle: BlurStyle.outer)],
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Stack(
            children: [
              const Align(alignment: Alignment.centerLeft, child: Icon(Icons.shopping_cart_outlined, size: 24, color: Colors.white)),
              Align(
                alignment: Alignment.center,
                child: Text(
                  'Ver sacola',
                  textAlign: TextAlign.center,
                  style: TextStyles.instance.textBold.copyWith(fontSize: 16, color: Colors.white),
                ),
              ),
              Align(
